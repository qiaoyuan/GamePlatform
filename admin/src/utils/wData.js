...
export const iconList = [
  ...
  { label: 'el-icon-picture-outline-round', value: 'el-icon-picture-outline-round' },
  ...
  { label: 'el-icon-video-camera-solid', value: 'el-icon-video-camera-solid' },
  ...
  { label: 'el-icon-c-scale-to-original', value: 'el-icon-c-scale-to-original' },
  ...
  { label: 'el-icon-document-checked', value: 'el-icon-document-checked' },
  ...
  { label: 'el-icon-shopping-cart-full', value: 'el-icon-shopping-cart-full' },
  ...
  { label: 'el-icon-chat-line-square', value: 'el-icon-chat-line-square' },
  ...
  { label: 'el-icon-turn-off-microphone', value: 'el-icon-turn-off-microphone' },
  { label: 'el-icon-microphone', value: 'el-icon-microphone' },
  { label: 'el-icon-close-notification', value: 'el-icon-close-notification' },
  ...
  { label: 'el-icon-location-outline', value: 'el-icon-location-outline' },
  { label: 'el-icon-location-information', value: 'el-icon-location-information' },
  ...
  { label: 'el-icon-cloudy-and-sunny', value: 'el-icon-cloudy-and-sunny' },
  ...
  { label: 'el-icon-goblet-square-full', value: 'el-icon-goblet-square-full' },
