...
CREATE TABLE `price_strategy_log` (
  ...
  `price_strategy_id` int unsigned NOT NULL DEFAULT 0 COMMENT '策略ID',
  `game_product_id` int unsigned NOT NULL DEFAULT 0 COMMENT '游戏产品ID',
  `old_price` decimal(12,5) NOT NULL DEFAULT 0.00000 COMMENT '改价前价格',
  `new_price` decimal(12,5) NOT NULL DEFAULT 0.00000 COMMENT '改价后价格',
  `ref_price` decimal(12,5) NOT NULL DEFAULT 0.00000 COMMENT '参考价(竞品最低价)',
